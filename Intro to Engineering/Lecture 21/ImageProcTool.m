...
% Last Modified by GUIDE v2.5 04-Apr-2017 14:53:58
...
a = handles.thresholdText.String;
handles.thresholdSlider.Value = str2double(a);
procImageF(handles)
...
a = handles.widthText.String;
handles.widthSlider.Value = str2double(a);
procImageF(handles)
