...
% Last Modified by GUIDE v2.5 02-Mar-2017 14:41:42
...
a = handles.dSlider.Value;
handles.dText.String = num2str(a);
plotCoasterF(handles)
...
b = handles.dText.String;
handles.dSlider.Value = str2double(b);
plotCoasterF(handles)
